...
static void ui_draw_debug(UIState *s) {
  ...
  if (scene.nDebugUi2) {
    ...
    ui_print(s, ui_viz_rx, ui_viz_ry+600, "X: %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f",
    ...
    ui_print(s, ui_viz_rx, ui_viz_ry+640, "0: %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f",
    ...
    ui_print(s, ui_viz_rx, ui_viz_ry+680, "1: %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f",
    ...
    ui_print(s, ui_viz_rx, ui_viz_ry+720, "C: %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f",
