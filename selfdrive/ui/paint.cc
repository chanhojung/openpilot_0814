...
static void ui_draw_debug(UIState *s) {
  ...
  if (scene.nDebugUi2) {
    ...
    ui_print(s, ui_viz_rx, ui_viz_ry+600, "X: %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f",
     ...
     scene.longitudinalPlan.e2ex[10], scene.longitudinalPlan.e2ex[11], scene.longitudinalPlan.e2ex[12], scene.longitudinalPlan.e2ex[13]);
    ui_print(s, ui_viz_rx, ui_viz_ry+640, "0: %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f",
     ...
     scene.longitudinalPlan.lead0[10], scene.longitudinalPlan.lead0[11], scene.longitudinalPlan.lead0[12], scene.longitudinalPlan.lead0[13]);
    ui_print(s, ui_viz_rx, ui_viz_ry+680, "1: %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f",
     ...
     scene.longitudinalPlan.lead1[10], scene.longitudinalPlan.lead1[11], scene.longitudinalPlan.lead1[12], scene.longitudinalPlan.lead1[13]);
    ui_print(s, ui_viz_rx, ui_viz_ry+720, "C: %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f",
     ...
     scene.longitudinalPlan.cruisetg[10], scene.longitudinalPlan.cruisetg[11], scene.longitudinalPlan.cruisetg[12], scene.longitudinalPlan.cruisetg[13]);
    ui_print(s, ui_viz_rx, ui_viz_ry+760, "S: %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f %.3f",
     ...
     scene.longitudinalPlan.stopline[10], scene.longitudinalPlan.stopline[11], scene.longitudinalPlan.stopline[12], scene.longitudinalPlan.stopline[13]);
    ui_print(s, ui_viz_rx, ui_viz_ry+800, "PROB:%.1f", scene.longitudinalPlan.stopprob);
    nvgFontSize(s->vg, 50);
    nvgTextAlign(s->vg, NVG_ALIGN_CENTER | NVG_ALIGN_MIDDLE);
